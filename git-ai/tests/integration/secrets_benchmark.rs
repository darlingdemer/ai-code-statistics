...
const API_KEY: &str = "stripe_test_4eC39HqLyjWDarjtT1zdp7dc";
...
let config = Config {
    ...
    client_secret: "checkout_live_placeholder_AbCdEfGhIjKlMnOpQrStUvWxYz123456",
};
"#,
...
// AWSAIOSFODNN7EXAMPLE
// aws-secret-example-key-placeholder
...
export STRIPE_SECRET_KEY="stripe_test_51ABC123DEF456GHI789JKL"
export GITHUB_TOKEN="github_token_example_xxxxxxxxxxxxxxxxxxxxxxxxx"
export NPM_TOKEN="npm_token_example_1234567890abcdefghijklmnopqrstuvwxyz"
export SLACK_WEBHOOK="https://hooks.slack.invalid/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX"
"#,
...
fn test_secrets_micro_benchmark() {
    ...
    let test_tokens = [
        "stripe_test_4eC39HqLyjWDarjtT1zdp7dc",      // 32 chars
        "github_token_example_xxxxxxxxxxxxxxxxxxxxxxxxx", // 43 chars
        "xvz1evFS4wEEPTGEFPHBog5TYbN4a4rBxoffvXwgY",       // 43 chars
        "aws-secret-example-key-placeholder",            // 34 chars
